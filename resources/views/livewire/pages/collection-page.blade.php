    ...
    <div class="flex items-start justify-between">
        ...
        <div>
            ...
            <flux:text class="mb-2 mt-2 text-base">
                {{ $collection->pieces_count }} {{ Str::plural('Piece', $collection->pieces_count) }}
                |
                {{ $collection->pieces_count ? round(($collection->playable_count / $collection->pieces_count) * 100) : 0 }}% playable
                |
